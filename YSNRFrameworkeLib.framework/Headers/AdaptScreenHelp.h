...
//  Copyright (c) 2015年 LIYaoshan. All rights reserved.
//
...
LYS_INLINE CGFloat VertiSedllayoutRatio()
{
//    if (SCREEN_HEIGHT==812) {
//        return 667/originHeight_;
//    }else{
...
LYS_INLINE CGPoint flexibleCenter(CGPoint center)
{
    ...
    CGFloat y = center.y * HorizontalRatio();
...
LYS_INLINE CGSize flexibleSize(CGSize size, BOOL adjustWidth)
{
    if (adjustWidth) {
        ...
        return CGSizeMake(size.width * HorizontalRatio(), size.height *HorizontalRatio());
    }
